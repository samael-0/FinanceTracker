...
export default function Sidebar() {
  ...
  return (
    <div className=" h-screen border-2 border-red-500 w-50 bg-black text-white ">
      <div className="w-50 border-2 h-screen flex flex-col px-4 py-7 gap-7">
        <div>FinanceTracker.IO</div>
        <div className="">
